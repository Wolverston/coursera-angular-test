...
var paths = {
    scripts: ['app/**/*.js','node_modules/lodash/dist/lodash.js'],
...
gulp.task('watch-dev', ['clean-build-app-dev', 'validate-devserver-scripts', 'browserSync'], function() {
...
gulp.task('watch-prod', ['clean-build-app-prod', 'validate-devserver-scripts', 'browserSync'], function() {
